...
const PromptSearchAtlas = (props: { inputState: Dispatch<SetStateAction<Photo[]>> ,count: string}) => {
  ...
  const searchImagesByText = async () => {
    ...
    const url = "./api/searchWebcamFromAtlas";
    const body = {
      query: query,
      count: count
    };
...
export default PromptSearchAtlas;